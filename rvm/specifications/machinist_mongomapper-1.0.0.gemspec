...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", "LICENSE", "README.textile", "Rakefile", "VERSION", "init.rb", "lib/machinist/mongomapper.rb", "machinist_mongomapper.gemspec", "spec/mongomapper_spec.rb", "spec/spec_helper.rb"]
  s.homepage = %q{http://github.com/yeastymobs/machinist_mongomapper}
  s.rdoc_options = ["--charset=UTF-8"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.3.7}
  s.summary = %q{Machinist adapter for MongoMapper}
  s.test_files = ["spec/mongomapper_spec.rb", "spec/spec_helper.rb"]
